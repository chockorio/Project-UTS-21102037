...
<body>
    ...
    <small>Copyright &copy; 2022 - RIO.COM. All Rights Reserved.</small>
...
<div class="wrapper">
        <project id="home">
            <div class="prjt">
                <h6>Pendeteksi Magnet</h6>
                <div class="gambar">
                    <img src="img/hasil.jpeg" style="width :650px;height: 450px;">
                </div>
                <p>Cara kerja dari sensor magnet yaitu mendeteksi kutub mana yang bisa di detek 
                    </p>    
            </div>
        </project>
</html>